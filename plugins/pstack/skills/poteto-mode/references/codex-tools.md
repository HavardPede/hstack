...
- Roles that default to the strongest Claude model (`feature, refactoring`, `bug-fix`, `perf-issue`, `hillclimb`, `how explorer`, `why investigators`, `reflect tooling`, `swarm workers`): your strongest Codex model (for example `gpt-6-astra`).
